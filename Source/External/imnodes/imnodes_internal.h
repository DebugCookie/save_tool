...
// [SECTION] global and myEditor context structs
...
{
    int    Id;
    ImVec2 Origin; // The node origin is in myEditor space
...
{
    // No myEditor context was set! Did you forget to call ImNodes::CreateContext()?
