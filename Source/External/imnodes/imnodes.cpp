...
static void MiniMapUpdate()
{
    ...
    GImNodes->CanvasDrawList->PushClipRect(
        mini_map_rect.Min, mini_map_rect.Max, true /* intersect with myEditor clip-rect */);
    ...
    // Draw myEditor canvas rect inside mini-map
    {
...
{
    // Check that myEditor size fraction is sane; must be in the range (0, 1]
