...
namespace ImGui
{
    ...
    IMGUI_API void          ShowStyleEditor(ImGuiStyle* ref = NULL);    // add style myEditor block (not a window). you can pass in a reference ImGuiStyle structure to compare to, revert to and save to (else it uses the default style)
    ...
    // Style read access
    // - Use the style myEditor (ShowStyleEditor() function) to interactively see what the colors are)
